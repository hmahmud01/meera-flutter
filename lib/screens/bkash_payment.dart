...
import '../models/pyament_request.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          WebView(
            initialUrl: 'https://meeraseed.com/bkashhost/payment.php', // api host link .
            //initialUrl: 'http://localhost/bkash/payment.php', // api host link .
